...
# make more short and smaller columns
...
def top_5_prod():
    ...
    prod_sales5 = prod_sales.sort_values(by=['sales'], ascending=False).iloc[0:5]
    return html.Div([
        html.H4('Top 5 Sales by Products', style={'text-align':'center', 'color':'white'}),
        dcc.Graph(figure = px.bar(prod_sales5, x='product', y='sales', color='year', barmode='group', height=350, 
        labels={'product':'Top 5 Sales by Products', 'sales':'Number of Sales', 'year':'Range by Year'})
